...
export const PINNED_POST_LIST_MOCK_DATA: PostItem[] = [
  {
    id: 1,
    title: '긴급 서버 점검 공지',
    content: '시스템 안정화를 위한 긴급 서버 점검이 예정되어 있습니다. 이용에 참고 바랍니다.',
  ...
  },
  {
    ...
    content: '이제 모바일 앱에서 다크 모드를 사용할 수 있습니다! 설정에서 변경해보세요.',
    postCategory: 'UPDATE',
  ...
  },
  {
    id: 3,
    title: '봄맞이 특별 이벤트 안내',
    content: '다가오는 봄을 맞아 특별한 이벤트를 준비했습니다. 자세한 사항은 공지를 확인해주세요!',
    postCategory: 'EVENT',
